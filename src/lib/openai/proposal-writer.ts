...
3. **ללא סופרלטיבים ריקים** - אל תכתוב "הכי טוב", "מוביל", "פורץ דרך", "חדשני", "ייחודי" ללא ביסוס. אם אין נתון ספציפי — אל תשתמש במילה
4. **ספציפיות** - מספרים, עובדות, תובנות קונקרטיות
5. **זרימה נרטיבית** - ההצעה צריכה לספר סיפור הגיוני
6. **ביטחון שקט** - מוכר בביטחון, לא בלחץ

## מילים וביטויים אסורים (אנטי-פטרנים):
- "בעידן הדיגיטלי" / "בעולם של היום" / "באזז" / "מעורר השראה"
- "חדשני" / "ייחודי" / "מוביל" / "פורץ דרך" (ללא ביסוס)
- משפטים מעל 15 מילים — פצל או קצר
- חזרה על אותה מילה בשני משפטים ברצף
- עברית נקייה: "שילוב" ולא "אינטגרציה", "מעורבות" ולא "אנגייג'מנט" (אלא אם זה שם מדד)
...
אם משפט יכול להתאים לכל מותג — הוא לא שייך להצעה הזו. מחק אותו.
